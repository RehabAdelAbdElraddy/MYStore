...
namespace StockWebsite.Controllers
{
    public class ItemsController : Controller
    {
        ...
        [HttpPost]
        public ActionResult purchase(IEnumerable<string> SelectedItems)
        {
            ...
            {
                List<Item> ItemsToPurchase = new List<Item>();
                foreach (var item in SelectedItems)
               {
                ...
                ViewBag.ListofItems = ItemsToPurchase.ToArray();
                return View("NewPurchaseView");
        ...
        [HttpPost]
        public ActionResult SubmitPurchaseOperation(string[] Quantities,  string[] ProductsName,string[] ProductsIDS,string[] ProductsQuantities)
        {
            ...
            {
                int intSelectedItems = Int32.Parse(ProductsIDS[j]);
                ...
                if (i != null)
                {
                    ...
                    i.ItemQuantity = i.ItemQuantity + int.Parse(Quantities[j]);
                    db.SaveChanges();
                }
            }
